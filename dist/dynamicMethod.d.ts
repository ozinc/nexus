 ...
 */
export declare function dynamicOutputMethod<T extends string>(
  config: DynamicOutputMethodConfig<T>
): DynamicOutputMethodDef<T>
/** Same as the outputFieldExtension, but for fields that should be added on as input types. */
export declare function dynamicInputMethod<T extends string>(
  config: DynamicInputMethodConfig<T>
): DynamicInputMethodDef<T>
