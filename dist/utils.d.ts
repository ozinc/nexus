...
export declare function mapValues<T, R>(
  obj: Record<string, T>,
  mapper: (val: T, key: string, index: number) => R
): Record<string, any>
...
export declare function assertNoMissingTypes(
  schema: GraphQLSchema,
  missingTypes: Record<string, MissingType>
): void
export declare function runAbstractTypeRuntimeChecks(
...
export declare function resolveImportPath(
  rootType: TypingImport,
  typeName: string,
  outputPath: string
): string
/** Given the right hand side of an arg definition, returns the underlying "named type" for us to add to the builder */
export declare function getArgNamedType(
  argDef: AllNexusArgsDefs | string
): AllNexusNamedInputTypeDefs | string
export declare function getNexusNamedType(
...
export declare function graphql15InterfaceConfig<T extends GraphQLInterfaceTypeConfig<any, any>>(
  config: T
): T & {
  interfaces: GraphQLInterfaceType[]
}
export declare function graphql15InterfaceType<T extends GraphQLInterfaceType>(
  type: T & {
