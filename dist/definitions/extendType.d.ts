...
export interface NexusExtendTypeConfig<TypeName extends string> {
   ...
   *
   * Nexus types this as all the object types in your schema but you can add new types here as well and
   * Nexus will create them for you. Note that this will appear to be a static type error until the next
   * Nexus reflection run.
   *
   * @example
   *   'Query'
   */
  type: TypeName
  /**
   * Define the fields you want to extend the type with. This method works almost exactly like the
   * objectType "definition" method.
   *
