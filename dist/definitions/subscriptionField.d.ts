...
export declare type SubscriptionFieldConfig<FieldName extends string, Event> =
 ...
 */
export declare function subscriptionField(
 ...
 */
export declare function subscriptionField<FieldName extends string, Event>(
  name: FieldName,
