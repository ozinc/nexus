...
export declare type SubscriptionScalarConfig<FieldName extends string, Event> = CommonOutputFieldConfig<
  'Subscription',
  FieldName
> &
...
export interface SubscriptionBuilder {
  ...
  string<FieldName extends string, Event>(
    fieldName: FieldName,
    config: SubscriptionScalarConfig<FieldName, Event>
  ): void
  int<FieldName extends string, Event>(
    fieldName: FieldName,
    config: SubscriptionScalarConfig<FieldName, Event>
  ): void
  boolean<FieldName extends string, Event>(
    fieldName: FieldName,
    opts: SubscriptionScalarConfig<FieldName, Event>
  ): void
  id<FieldName extends string, Event>(
    fieldName: FieldName,
    config: SubscriptionScalarConfig<FieldName, Event>
  ): void
  float<FieldName extends string, Event>(
    fieldName: FieldName,
    config: SubscriptionScalarConfig<FieldName, Event>
  ): void
  field<FieldName extends string, Event>(
    name: FieldName,
    fieldConfig: SubscriptionTypeConfig<FieldName, Event>
  ): void
}
...
export declare function subscriptionType(
  config: SubscriptionTypeParams
): import('./objectType').NexusObjectTypeDef<string>
