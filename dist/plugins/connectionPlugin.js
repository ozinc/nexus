...
exports.ForwardPaginateArgs = {
  ...
  after: nullable_1.nullable(
    args_1.stringArg({ description: 'Returns the elements in the list that come after the specified cursor' })
  ),
}
exports.ForwardOnlyStrictArgs = Object.assign(Object.assign({}, exports.ForwardPaginateArgs), {
  first: nonNull_1.nonNull(args_1.intArg({ description: 'Returns the first n elements from the list.' })),
})
exports.BackwardPaginateArgs = {
  last: nullable_1.nullable(args_1.intArg({ description: 'Returns the last n elements from the list.' })),
  before: nullable_1.nullable(
    args_1.stringArg({
...
exports.BackwardOnlyStrictArgs = Object.assign(Object.assign({}, exports.BackwardPaginateArgs), {
  last: nonNull_1.nonNull(args_1.intArg({ description: 'Returns the last n elements from the list.' })),
})
      ...
      config: connectionPluginCore.ConnectionFieldConfig<TypeName, FieldName>${printedDynamicConfig}
          ...
          factory({ typeName: parentTypeName, typeDef: t, args: factoryArgs, stage, builder, wrapping }) {
            ...
            if (!b.hasType(connectionName)) {
              b.addType(
                objectType_1.objectType({
                  ...
                  nonNullDefaults:
                    (_a = fieldConfig.nonNullDefaults) !== null && _a !== void 0
                      ? _a
              ...
              b.addType(
                objectType_1.objectType({
                  ...
                  definition(t2) {
                    t2.field('cursor', {
                      type:
                        cursorType !== null && cursorType !== void 0
                          ? cursorType
                          : nonNull_1.nonNull('String'),
                  ...
                  nonNullDefaults:
                    (_b = fieldConfig.nonNullDefaults) !== null && _b !== void 0
                      ? _b
                      : pluginConfig.nonNullDefaults,
                })
              )
            ...
            if (disableForwardPagination !== true && disableBackwardPagination !== true) {
              specArgs = Object.assign(
                Object.assign({}, exports.ForwardPaginateArgs),
                exports.BackwardPaginateArgs
              )
            } else if (disableForwardPagination !== true) {
              specArgs = strictArgs
                ? Object.assign({}, exports.ForwardOnlyStrictArgs)
                : Object.assign({}, exports.ForwardPaginateArgs)
            } else if (disableBackwardPagination !== true) {
              specArgs = strictArgs
                ? Object.assign({}, exports.BackwardOnlyStrictArgs)
                : Object.assign({}, exports.BackwardPaginateArgs)
            }
                    ...
                    if (val && val.nodes === undefined) {
                      return withArgs(
                        ...
                        Object.assign(
                          {
                            get nodes() {
                              return plugin_1.completeValue(val.edges, (edges) =>
...
function makeResolveFn(pluginConfig, fieldConfig) {
  ...
  return (root, args, ctx, info) => {
    ...
    const resolveAllNodes = () => {
      ...
      cachedNodes = plugin_1.completeValue(
        (_a = nodesResolve(root, formattedArgs, ctx, info)) !== null && _a !== void 0 ? _a : null,
        (allNodes) => {
    ...
    const resolvePageInfo = () => {
      return plugin_1.completeValue(resolveAllNodes(), (allNodes) =>
        plugin_1.completeValue(resolveEdgesAndNodes(), ({ edges }) =>
          plugin_1.completeValue(
            allNodes
    ...
    if (pluginConfig.extendConnection) {
      Object.keys(pluginConfig.extendConnection).forEach((connectionField) => {
        var _a
        const resolve =
          (_a = fieldConfig[connectionField]) !== null && _a !== void 0 ? _a : graphql_1.defaultFieldResolver
...
function wrapEdge(pluginConfig, fieldConfig, formattedArgs, edgeParentType) {
  ...
  if (pluginConfig.extendEdge) {
    Object.keys(pluginConfig.extendEdge).forEach((edgeField) => {
      var _a, _b
      const resolve =
        (_b = (_a = fieldConfig.edgeFields) === null || _a === void 0 ? void 0 : _a[edgeField]) !== null &&
        _b !== void 0
          ? _b
...
const assertCorrectConfig = (typeName, fieldName, pluginConfig, fieldConfig) => {
  ...
  utils_1.eachObj(pluginConfig.extendEdge || {}, (val, key) => {
    var _a
    if (
      typeof ((_a = fieldConfig.edgeFields) === null || _a === void 0 ? void 0 : _a[key]) !== 'function' &&
      val.requireResolver !== false
    ) {
      console.error(
        new Error(
