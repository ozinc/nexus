...
export declare type NullabilityGuardConfig = {
  /**
   * Whether we should guard against non-null values. Defaults to "true" if NODE_ENV === "production", false
   * otherwise.
   */
  shouldGuard?: boolean
  /**
   * When a nullish value is "guarded", meaning it is coerced into an acceptable non-null value, this
   * function will be called if supplied.
   */
...
export declare const nullabilityGuardPlugin: (
  pluginConfig: NullabilityGuardConfig
) => import('../plugin').NexusPlugin
