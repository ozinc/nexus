...
export declare type QueryComplexityEstimator<TypeName extends string, FieldName extends string> = (
  options: QueryComplexityEstimatorArgs<TypeName, FieldName>
) => number | void
export declare type QueryComplexity<TypeName extends string, FieldName extends string> =
  | number
