...
export interface SourceTypeModule {
  /**
   * The module for where to look for the types. This uses the node resolution algorithm via
   * require.resolve, so if this lives in node_modules, you can just provide the module name otherwise you
   * should provide the absolute path to the file.
   */
  module: string
  /**
 ...
 * @param options
 */
export declare function typegenAutoConfig(
  options: SourceTypesConfigOptions,
  contextType: TypingImport | undefined
): (schema: GraphQLSchema, outputPath: string) => Promise<TypegenInfo>
